...
|[Создание ETL-пайплайна](https://github.com/Kateri-Che/etl-project)|Создание DAG-а для сбора информации о метриках бизнеса и загрузки данных в таблицу в ClickHouse| airflow, pandas, pandahouse, clickhouse, numpy, os|
