...
|[API музейной коллекции](https://github.com/Kateri-Che/museum-collection-requests)| Сбор и обработка данных об объектах и департаментах музея с использованием API музейной коллекции|requests, pandas, json|
